...
void printKeyDER(bytearray_t privkey_der,  const std::string& type_key) {
    ...
    if (type_key == "priv")
        std::cout << "Print the byte-array representation of the private key: ";
    else
        std::cout << "Print the byte-array representation of the public key: ";
    ...
    if (type_key == "priv")
        std::cout << "Print the hexadecimal representation of the private key: ";
    else
        std::cout << "Print the hexadecimal representation of the public key: ";
